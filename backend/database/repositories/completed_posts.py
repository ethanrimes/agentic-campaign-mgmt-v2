...
class CompletedPostRepository(BaseRepository[CompletedPost]):
    ...
    def get_by_task_id(self, task_id: UUID) -> List[CompletedPost]:
    ...
    def mark_failed(self, post_id: UUID, error_message: str) -> CompletedPost | None:
        """Mark a post as failed."""
        return self.update(post_id, {"status": "failed", "error_message": error_message})

    def get_recent_by_platform(
